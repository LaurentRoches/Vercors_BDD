...
<div id="dashboard" class="modal top-0 w-screen  min-h-screen bg-gradient-to-b from-teal-400 from-5% via-red-400 via-35%  to-yellow-200 to-95% ">
    ...
    <div class=" h-dvh w-1/5 flex-col flex items-center bg-white justify-between fixed ">
        ...
        <button onclick="location.href='<?= HOME_URL ?>pageResa'" id="openModalResa" class="mt-10 flex-col flex items-center justify-center rounded-lg cursor-pointer hover:text-gray-800 hover:bg-white  hover:duration-300 hover:ease-linear focus:bg-white">
